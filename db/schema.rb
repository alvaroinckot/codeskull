...
ActiveRecord::Schema.define(version: 20160923210205) do
  ...
  add_index "expectations", ["task_id"], name: "index_expectations_on_task_id", using: :btree
  ...
  add_foreign_key "expectations", "tasks"
